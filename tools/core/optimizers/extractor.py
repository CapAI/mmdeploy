...
def _dfs_search_reachable_nodes_fast(self, node_output_name, graph_input_nodes, reachable_nodes):
...
def create_extractor(model: onnx.ModelProto) -> onnx.utils.Extractor:
    ...
    # patch extractor
    onnx.utils.Extractor._dfs_search_reachable_nodes = _dfs_search_reachable_nodes_fast
