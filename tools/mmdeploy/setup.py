...
def get_extensions():
    ...
    if EXT_TYPE == "torch":
        ...
        op_files = (
            glob.glob("./csrc/mmdeploy/backend_ops/torchscript/optimizer/*.cpp")
            + glob.glob("./csrc/mmdeploy/backend_ops/torchscript/optimizer/ir/*.cpp")
            + glob.glob("./csrc/mmdeploy/backend_ops/torchscript/optimizer/passes" "/onnx/*.cpp")
        )
