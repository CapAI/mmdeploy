...
from mmdeploy.utils import get_common_config, get_model_inputs, get_root_logger, load_config
...
def parse_args():
    ...
    parser.add_argument("--calib-file", help="`the calibration data used to calibrate engine to int8", default=None)
