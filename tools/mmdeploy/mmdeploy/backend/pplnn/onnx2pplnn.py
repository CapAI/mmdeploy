...
def from_onnx(
    ...
    **kwargs,
    ...
    if input_shapes is None:
        input_shapes = [[1, 3, 224, 224]]  # PPLNN default shape for optimization

    algo_file = output_file_prefix + ".json"
    onnx_output_path = output_file_prefix + ".onnx"
    engines = register_engines(
        device_id, disable_avx512=False, quick_select=False, export_algo_file=algo_file, input_shapes=input_shapes
    )
