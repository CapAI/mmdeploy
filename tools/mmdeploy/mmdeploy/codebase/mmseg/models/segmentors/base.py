...
@FUNCTION_REWRITER.register_rewriter(func_name="mmseg.models.segmentors.BaseSegmentor.forward")
def base_segmentor__forward(self, inputs, data_samples=None, mode="predict", **kwargs):
