...
@FUNCTION_REWRITER.register_rewriter(
    func_name="mmseg.models.decode_heads.point_head.PointHead.get_points_test", backend="tensorrt"
)
def point_head__get_points_test__tensorrt(self, seg_logits, uncertainty_func, cfg):
    ...
    if cfg.subdivision_num_points > TENSORRT_MAX_TOPK:
        ...
        logger.warning(
            f"cfg.subdivision_num_points would be changed from "
