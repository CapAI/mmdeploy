...
class End2EndModel(BaseBackendModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.head = builder.build_head(model_cfg.model.head) if hasattr(model_cfg.model, "head") else None
    ...
    def pack_result(
        self, preds: Sequence[InstanceData], data_samples: List[BaseDataElement], convert_coordinate: bool = True
    ):
...
class SDKEnd2EndModel(End2EndModel):
    ...
    def forward(
        self, inputs: List[torch.Tensor], data_samples: List[BaseDataElement], mode: str = "predict", **kwargs
    ) -> list:
        """Run forward inference.
        ...
        for input_img, sample in zip(inputs, data_samples):
            ...
            pred = InstanceData(keypoints=keypoints[..., :2], keypoint_scores=keypoints[..., 2])
