...
@FUNCTION_REWRITER.register_rewriter("mmpose.models.utils.rtmcc_block.ScaleNorm.forward", backend="ncnn")
...
@FUNCTION_REWRITER.register_rewriter("mmpose.models.utils.rtmcc_block.RTMCCBlock._forward", backend="ncnn")
def rtmccblock___forward_ncnn(self, inputs):
    ...
    if self.attn_type == "self-attn":
        ...
        q = (base.unsqueeze(1) * self.gamma[None, None, 0:1, :] + self.beta[None, None, 0:1, :]).squeeze(1)
        k = (base.unsqueeze(1) * self.gamma[None, None, 1:2, :] + self.beta[None, None, 1:2, :]).squeeze(1)
...
@FUNCTION_REWRITER.register_rewriter("mmpose.models.utils.rtmcc_block.Scale.forward", backend="ncnn")
