...
@FUNCTION_REWRITER.register_rewriter("mmpose.models.heads.heatmap_heads.CPMHead.forward")
@FUNCTION_REWRITER.register_rewriter("mmpose.models.heads.heatmap_heads.MSPNHead.forward")
