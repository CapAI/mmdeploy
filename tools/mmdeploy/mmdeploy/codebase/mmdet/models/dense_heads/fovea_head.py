...
@FUNCTION_REWRITER.register_rewriter("mmdet.models.dense_heads.fovea_head.FoveaHead.predict_by_feat")
def fovea_head__predict_by_feat(
    ...
    det_bboxes = []
    det_scores = []
    for cls_score, bbox_pred, base_len, point in zip(cls_score_list, bbox_pred_list, self.base_edge_list, mlvl_priors):
