...
@FUNCTION_REWRITER.register_rewriter(func_name="mmdet.models.dense_heads.rpn_head." "RPNHead.predict_by_feat")
...
# TODO: Fix for 1.x
@FUNCTION_REWRITER.register_rewriter("mmdet.models.dense_heads.RPNHead.get_bboxes", backend=Backend.NCNN.value)
def rpn_head__get_bboxes__ncnn(self, cls_scores, bbox_preds, img_metas, with_nms=True, cfg=None, **kwargs):
