...
@FUNCTION_REWRITER.register_rewriter(
    func_name="mmdet.models.task_modules.coders.delta_xywh_bbox_coder." "DeltaXYWHBBoxCoder.decode", backend="default"
)
def deltaxywhbboxcoder__decode(self, bboxes, pred_bboxes, max_shape=None, wh_ratio_clip=16 / 1000):
...
@FUNCTION_REWRITER.register_rewriter(
    func_name="mmdet.models.task_modules.coders" ".delta_xywh_bbox_coder.delta2bbox", backend="default"
)
def delta2bbox(
    rois,
    deltas,
...
@FUNCTION_REWRITER.register_rewriter(
    func_name="mmdet.models.task_modules.coders." "delta_xywh_bbox_coder.delta2bbox", backend="ncnn"
)
