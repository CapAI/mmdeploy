...
@FUNCTION_REWRITER.register_rewriter(
    func_name="mmrotate.models.dense_heads.rotated_rtmdet_head." "RotatedRTMDetHead.predict_by_feat"
)
def rotated_rtmdet_head__predict_by_feat(
    ...
    flatten_angle_preds = [
        angle_pred.permute(0, 2, 3, 1).reshape(batch_size, -1, self.angle_coder.encode_size)
    ...
    return multiclass_nms_rotated(
        bboxes, scores, max_output_boxes_per_class, iou_threshold, score_threshold, pre_top_k, keep_top_k
    )
