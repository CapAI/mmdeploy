...
@FUNCTION_REWRITER.register_rewriter("mmpretrain.models.classifiers.ImageClassifier.forward", backend="default")
@FUNCTION_REWRITER.register_rewriter("mmpretrain.models.classifiers.BaseClassifier.forward", backend="default")
def base_classifier__forward(
    self, batch_inputs: Tensor, data_samples: Optional[List[BaseDataElement]] = None, mode: str = "predict"
):
