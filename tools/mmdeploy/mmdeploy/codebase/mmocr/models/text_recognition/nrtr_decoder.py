...
@FUNCTION_REWRITER.register_rewriter(func_name="mmocr.models.textrecog.NRTRDecoder._get_source_mask")
def nrtr_decoder___get_source_mask(self, src_seq: torch.Tensor, valid_ratios: Sequence[float]) -> torch.Tensor:
