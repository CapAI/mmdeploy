...
@FUNCTION_REWRITER.register_rewriter(func_name="mmocr.models.textrecog.encoders.SAREncoder.forward", backend="default")
def sar_encoder__forward(self, feat: torch.Tensor, data_samples: Optional[Sequence[TextRecogDataSample]] = None):
