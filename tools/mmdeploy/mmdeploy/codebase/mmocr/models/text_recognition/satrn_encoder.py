...
@FUNCTION_REWRITER.register_rewriter(func_name="mmocr.models.textrecog.SATRNEncoder.forward")
def satrn_encoder__forward(self, feat: Tensor, data_samples: List[TextRecogDataSample] = None) -> Tensor:
