...
def build_task_processor(model_cfg: mmengine.Config, deploy_cfg: mmengine.Config, device: str) -> BaseTask:
...
def to_backend(
    ...
    **kwargs,
    ...
    return backend_mgr.to_backend(
        ir_files=ir_files, work_dir=work_dir, deploy_cfg=deploy_cfg, log_level=log_level, device=device, **kwargs
    )
