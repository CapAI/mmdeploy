...
class FunctionRewriter:
    ...
    def register_rewriter(
        ...
        **kwargs,
        ...
        return self._registry.register_object(func_name, backend, ir, extra_checkers, **kwargs)
    ...
    def enter(self, cfg: Dict = dict(), env: Dict = dict(), **kwargs):
        ...
        for function_path, record_dict in functions_records:
            ...
            try:
                ...
                logger.warning(f"Can not find {function_path}, function rewrite will " "not be applied")
            ...
            if origin_func is not None:
                ...
                self._origin_functions.append(dict(func_path=function_path, origin_func=origin_func))
                ...
                context_caller = ContextCaller(rewrite_function, origin_func, cfg, **extra_kwargs)
                ...
                new_functions.append(dict(func_path=function_path, origin_func=rewrite_function))
