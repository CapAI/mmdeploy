...
@SYMBOLIC_REWRITER.register_symbolic("layer_norm", is_pytorch=True, arg_descriptors=["v", "is", "v", "v", "f", "i"])
...
@SYMBOLIC_REWRITER.register_symbolic("layer_norm", is_pytorch=True, backend=Backend.NCNN.value)
