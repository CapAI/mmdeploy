...
def test_build_pose_detection_model():
    ...
    with SwitchBackendWrapper(ORTWrapper) as wrapper:
        ...
        from mmdeploy.codebase.mmpose.deploy.pose_detection_model import End2EndModel, build_pose_detection_model

        posedetector = build_pose_detection_model([""], model_cfg, deploy_cfg, "cpu")
