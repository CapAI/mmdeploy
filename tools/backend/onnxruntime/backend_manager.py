...
class ONNXRuntimeManager(BaseBackendManager):
    ...
    def build_wrapper(
        ...
        **kwargs,
        ...
        return ORTWrapper(onnx_file=backend_files[0], device=device, output_names=output_names)
    ...
    def get_version(cls) -> str:
        ...
        if not cls.is_available():
            ...
            try:
                ...
                ort_version = "None"
            try:
                ort_gpu_version = pkg_resources.get_distribution("onnxruntime-gpu").version
            except Exception:
    ...
    @classmethod
    def to_backend(
        cls, ir_files: Sequence[str], work_dir: str, log_level: int = logging.INFO, device: str = "cpu", **kwargs
    ) -> Sequence[str]:
