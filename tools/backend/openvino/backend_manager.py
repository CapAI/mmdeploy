...
class OpenVINOManager(BaseBackendManager):
    ...
    def build_wrapper(
        ...
        **kwargs
        ...
        return OpenVINOWrapper(ir_model_file=backend_files[0], output_names=output_names)
    ...
    def to_backend(
        ...
        **kwargs
        ...
        assert is_available(), "OpenVINO is not available, please install OpenVINO first."

        from mmdeploy.apis.openvino import get_input_info_from_cfg, get_mo_options_from_cfg, get_output_model_file
        ...
        for onnx_path in ir_files:
            ...
            from_onnx(onnx_path, work_dir, input_info, output_names, mo_options)
