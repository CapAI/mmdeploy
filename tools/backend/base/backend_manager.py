...
class BaseBackendManager(metaclass=ABCMeta):
        ...
        **kwargs,
        ...
        Args:
            ...
            deploy_cfg (Optional[Any], optional): The deploy config. Defaults
                to None.
        """
        raise NotImplementedError(f"build_wrapper has not been implemented for `{cls.__name__}`")
    ...
    def is_available(cls, with_custom_ops: bool = False) -> bool:
        ...
        """
        raise NotImplementedError(f'is_available has not been implemented for "{cls.__name__}"')

    @classmethod
    def get_version(cls) -> str:
        """Get the version of the backend."""
        raise NotImplementedError(f'get_version has not been implemented for "{cls.__name__}"')
    ...
    def to_backend(
        ...
        **kwargs,
        ...
        """
        raise NotImplementedError(f"to_backend has not been implemented for `{cls.__name__}`")
