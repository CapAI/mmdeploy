...
def parse_args():
    ...
    parser.add_argument(
        "--bbox", default=None, nargs="+", type=int, help="bounding box of an object in format (x, y, w, h)"
    )
...
def main():
    ...
    detector = PoseDetector(model_path=args.model_path, device_name=args.device_name, device_id=0)
