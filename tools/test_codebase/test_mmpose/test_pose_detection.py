...
try:
    ...
    pytest.skip(f"{Codebase.MMPOSE.value} is not installed.", allow_module_level=True)

from .utils import generate_datasample, generate_mmpose_deploy_config, generate_mmpose_task_processor
