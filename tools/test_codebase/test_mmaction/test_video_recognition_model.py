...
try:
    ...
    pytest.skip(f"{Codebase.MMACTION} is not installed.", allow_module_level=True)
...
class TestEnd2EndModel:
    ...
    def setup_class(cls):
        ...
        from mmdeploy.codebase.mmaction.deploy.video_recognition_model import End2EndModel
    ...
    def test_forward(self):
        ...
        data_sample = ActionDataSample(metainfo=dict(img_shape=(IMAGE_SIZE, IMAGE_SIZE)))
        results = self.end2end_model.forward(inputs, [data_sample], mode="predict")
...
def test_build_video_recognition_model():
    ...
    with SwitchBackendWrapper(ORTWrapper) as wrapper:
        ...
        classifier = build_video_recognition_model([""], model_cfg, deploy_cfg, "cpu")
