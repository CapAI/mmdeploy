...
@FUNCTION_REWRITER.register_rewriter(func_name="mmocr.models.textdet.SingleStageTextDetector.forward")
def single_stage_text_detector__forward(
    self, batch_inputs: torch.Tensor, data_samples: TextDetDataSample = None, **kwargs
