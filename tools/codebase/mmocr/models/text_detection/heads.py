...
@FUNCTION_REWRITER.register_rewriter(func_name="mmocr.models.textdet.heads.BaseTextDetHead.predict")
def base_text_det_head__predict(self, x: torch.Tensor, batch_data_samples: DetSampleList) -> DetSampleList:
...
@FUNCTION_REWRITER.register_rewriter(func_name="mmocr.models.textdet.heads.DBHead.predict")
def db_head__predict(self, x: torch.Tensor, batch_data_samples: DetSampleList) -> DetSampleList:
