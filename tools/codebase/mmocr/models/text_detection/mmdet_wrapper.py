...
@FUNCTION_REWRITER.register_rewriter(func_name="mmocr.models.textdet.detectors.MMDetWrapper.forward")
def mmdet_wrapper__forward(
    self,
    inputs: torch.Tensor,
    ...
    **kwargs
    ...
    if mode == "predict":
        ...
        for i in range(len(ocr_data_samples)):
            data_samples.append(DetDataSample(metainfo=ocr_data_samples[i].metainfo))
