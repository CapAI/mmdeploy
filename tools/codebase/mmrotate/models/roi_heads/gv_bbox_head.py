...
@FUNCTION_REWRITER.register_rewriter("mmrotate.models.roi_heads.bbox_heads.GVBBoxHead.predict_by_feat")
def gv_bbox_head__predict_by_feat(
    ...
    qboxes = qboxes.where(ratio_preds.unsqueeze(-1) < self.ratio_thr, hbox2qbox(bboxes))
