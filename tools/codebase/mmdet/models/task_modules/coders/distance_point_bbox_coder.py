...
@FUNCTION_REWRITER.register_rewriter(
    func_name="mmdet.models.task_modules.coders.distance_point_bbox_coder" ".DistancePointBBoxCoder.decode",
    backend="default",
)
def distancepointbboxcoder__decode(self, points, pred_bboxes, max_shape=None):
    ...
    return mmdet.structures.bbox.transforms.distance2bbox(points, pred_bboxes, max_shape)
