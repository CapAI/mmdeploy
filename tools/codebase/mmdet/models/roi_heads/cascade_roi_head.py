...
@FUNCTION_REWRITER.register_rewriter("mmdet.models.roi_heads.cascade_roi_head.CascadeRoIHead.predict_bbox")
...
@FUNCTION_REWRITER.register_rewriter("mmdet.models.roi_heads.cascade_roi_head.CascadeRoIHead.predict_mask")
