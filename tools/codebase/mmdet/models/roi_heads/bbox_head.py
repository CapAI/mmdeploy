...
@FUNCTION_REWRITER.register_rewriter("mmdet.models.roi_heads.bbox_heads.bbox_head.BBoxHead.forward")
@FUNCTION_REWRITER.register_rewriter("mmdet.models.roi_heads.bbox_heads.convfc_bbox_head.ConvFCBBoxHead.forward")
...
@FUNCTION_REWRITER.register_rewriter("mmdet.models.roi_heads.bbox_heads.bbox_head.BBoxHead.predict_by_feat")
