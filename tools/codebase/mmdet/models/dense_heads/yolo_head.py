...
@FUNCTION_REWRITER.register_rewriter(func_name="mmdet.models.dense_heads.yolo_head." "YOLOV3Head.predict_by_feat")
def yolov3_head__predict_by_feat(
    self, pred_maps: Sequence[Tensor], cfg: OptConfigType = None, rescale: bool = False, with_nms: bool = True, **kwargs
):
    ...
    for i in range(self.num_levels):
        ...
        cls_pred = torch.sigmoid(pred_map[..., 5:]).view(batch_size, -1, self.num_classes)  # Cls pred one-hot.
...
@FUNCTION_REWRITER.register_rewriter(
    func_name="mmdet.models.dense_heads.YOLOV3Head.predict_by_feat", backend=Backend.NCNN.value
)
