...
@FUNCTION_REWRITER.register_rewriter(func_name="mmdet.models.dense_heads.rtmdet_head." "RTMDetHead.predict_by_feat")
...
@FUNCTION_REWRITER.register_rewriter(
    func_name="mmdet.models.dense_heads.rtmdet_head." "RTMDetHead.predict_by_feat", backend=Backend.NCNN.value
)
