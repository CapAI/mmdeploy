...
@FUNCTION_REWRITER.register_rewriter(func_name="mmdet.models.necks.ssd_neck.L2Norm.forward")
...
@FUNCTION_REWRITER.register_rewriter(
    func_name="mmdet.models.necks.ssd_neck.L2Norm.forward", backend=Backend.TENSORRT.value
)
