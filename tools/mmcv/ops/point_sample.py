...
@FUNCTION_REWRITER.register_rewriter(func_name="mmcv.ops.point_sample", backend="default")
...
def simple_roialign__forward(self, features, rois):
    ...
    """
    from mmcv.ops.point_sample import generate_grid, point_sample, rel_roi_point_to_rel_img_point
