...
def install_protobuf(dep_dir) -> int:
    ...
    os.system(""" echo 'export PATH={}:$PATH' >> ~/mmdeploy.env """.format(os.path.join(install_dir, "bin")))
    os.system(
...
def install_pyncnn(dep_dir):
    ...
    if not os.path.exists("ncnn"):
        os.system("git clone --depth 1 --branch 20230517 https://github.com/tencent/ncnn && cd ncnn")  # noqa: E501
    ...
    ncnn_cmake_dir = os.path.join(ncnn_dir, "build", "install", "lib", "cmake", "ncnn")
