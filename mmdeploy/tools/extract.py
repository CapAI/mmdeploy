...
def parse_args():
    parser = argparse.ArgumentParser(description="Extract model based on markers.")
    parser.add_argument("input_model", help="Input ONNX model")
    parser.add_argument("output_model", help="Output ONNX model")
    parser.add_argument("--start", help="Start markers, format: func:type, e.g. backbone:input")
