...
@pytest.mark.parametrize("model_cfg_path", ["tests/test_codebase/test_mmaction/data/model.py"])
def test_forward_of_base_recognizer(model_cfg_path, backend):
    ...
    wrapped_model = WrapModel(model, "forward", data_samples=[data_sample], mode="predict")
