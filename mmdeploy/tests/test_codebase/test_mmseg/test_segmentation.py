...
def test_build_pytorch_model(from_mmrazor: Any):
    ...
    if from_mmrazor is False:
        ...
        _model_cfg_path = "tests/test_codebase/test_mmseg/data/" "mmrazor_model.py"
...
def test_create_input():
    ...
    inputs = task_processor.create_input(img_path, input_shape=img_shape, data_preprocessor=data_preprocessor)
...
def test_build_dataset_and_dataloader():
    ...
    dataset = task_processor.build_dataset(dataset_cfg=val_dataloader["dataset"])
...
def test_visualize():
    ...
    task_processor.visualize(img, datasample, output_file, show_result=False, window_name="test")
