...
def test_module_rewriter():
    ...
    @MODULE_REWRITER.register_rewrite_module(module_type="torchvision.models.resnet.Bottleneck", backend="tensorrt")
...
def test_pass_redundant_args_to_model():
    ...
    @MODULE_REWRITER.register_rewrite_module(module_type="torchvision.models.resnet.Bottleneck")
    class BottleneckWrapper(torch.nn.Module):
