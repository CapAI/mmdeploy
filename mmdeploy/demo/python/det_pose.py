...
def parse_args():
    ...
    parser.add_argument("det_model_path", help="path of mmdeploy SDK model dumped by model converter")
    parser.add_argument("pose_model_path", help="path of mmdeploy SDK model dumped by model converter")
