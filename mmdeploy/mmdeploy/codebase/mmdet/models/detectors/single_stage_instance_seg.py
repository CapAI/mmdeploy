...
@mark("instance_segmentor_forward", inputs=["input"], outputs=["dets", "labels", "masks"])
...
def single_stage_instance_segmentor__forward(
    ...
    return __forward_impl_instance_seg(self, batch_inputs, data_samples=data_samples, **kwargs)
