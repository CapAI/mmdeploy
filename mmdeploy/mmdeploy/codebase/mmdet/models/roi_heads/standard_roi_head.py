...
@FUNCTION_REWRITER.register_rewriter("mmdet.models.roi_heads.standard_roi_head.StandardRoIHead.predict_bbox")
...
@FUNCTION_REWRITER.register_rewriter("mmdet.models.roi_heads.standard_roi_head.StandardRoIHead.predict_mask")
def standard_roi_head__predict_mask(
    self, x: Tuple[Tensor], batch_img_metas: List[dict], results_list: List[Tensor], rescale: bool = False
) -> List[Tensor]:
