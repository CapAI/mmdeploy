...
@FUNCTION_REWRITER.register_rewriter(func_name="mmseg.models.segmentors.CascadeEncoderDecoder.predict")
def cascade_encoder_decoder__predict(self, inputs, data_samples, **kwargs):
    ...
    seg_logit = self.decode_head[-1].predict(x, out, batch_img_metas, self.test_cfg)
    return seg_logit
