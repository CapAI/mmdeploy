...
class DeployTestRunner(Runner):
    ...
    def __init__(self, log_file: Optional[str] = None, device: str = get_device(), *args, **kwargs):
        self._log_file = log_file
        self._device = device
        super(DeployTestRunner, self).__init__(*args, **kwargs)

    def wrap_model(self, model_wrapper_cfg: Optional[Dict], model: BaseModel) -> BaseModel:
    ...
    def build_logger(self, log_level: Union[int, str] = "INFO", log_file: str = None, **kwargs) -> MMLogger:
