...
@FUNCTION_REWRITER.register_rewriter(func_name="mmocr.models.textrecog.EncoderDecoderRecognizer.forward")
def encoder_decoder_recognizer__forward(
    self, batch_inputs: torch.Tensor, data_samples: TextRecogDataSample, **kwargs
) -> TextRecogDataSample:
