...
@FUNCTION_REWRITER.register_rewriter("mmdet3d.models.detectors.mvx_two_stage.MVXTwoStageDetector.extract_feat")
def mvxtwostagedetector__extract_feat(self, batch_inputs_dict: dict) -> tuple:
    ...
    pts_feats = self.extract_pts_feat(voxel_dict, points=points, img_feats=img_feats)
    return (img_feats, pts_feats)


@FUNCTION_REWRITER.register_rewriter("mmdet3d.models.detectors.mvx_two_stage.MVXTwoStageDetector.forward")
def mvxtwostagedetector__forward(self, inputs: list, **kwargs):
    ...
    deploy_cfg = ctx.cfg
    batch_inputs_dict = {"voxels": {"voxels": inputs[0], "num_points": inputs[1], "coors": inputs[2]}}
