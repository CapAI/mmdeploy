...
class PipelineCaller:
    ...
    def pop_mp_output(self, call_id: int = None) -> Any:
        ...
        if call_id not in self._mp_dict:
            get_root_logger().error(f"`{self._func_name}` with Call id: {call_id} failed. exit.")
            exit(1)
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any:
        do_multiprocess = self.is_multiprocess_available and self.is_multiprocess and self._mp_dict is not None
...
class PipelineManager:
    ...
    def __set_caller_val(self, val_name: str, val: Any, func_name: Optional[FUNC_NAME_TYPE] = None) -> None:
    ...
    def _enable_multiprocess_single(self, val: bool, func_name: FUNC_NAME_TYPE = None) -> None:
    ...
    def enable_multiprocess(
        self, val: bool, func_names: Optional[Union[FUNC_NAME_TYPE, Sequence[FUNC_NAME_TYPE]]] = None
    ) -> None:
    ...
    def set_mp_async(self, val: bool, func_name: Optional[FUNC_NAME_TYPE] = None) -> None:
    ...
    def set_log_level(
        self, level: int, func_names: Optional[Union[FUNC_NAME_TYPE, Sequence[FUNC_NAME_TYPE]]] = None
    ) -> None:
    ...
    def call_function_async(self, func_name: FUNC_NAME_TYPE, *args, **kwargs) -> int:
        ...
        """
        pipe_caller = self.get_caller(func_name)
        assert pipe_caller.is_multiprocess, f"multiprocess of {func_name} has not been enabled."
    ...
    def register_pipeline(self, is_multiprocess_available: bool = True, log_level: int = logging.DEBUG):
