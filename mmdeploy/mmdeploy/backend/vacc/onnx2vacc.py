...
def from_onnx(onnx_model: str, output_path: str, model_input: dict, model_name: str, **kwargs):
    ...
    with tvm.build_config(
        data_type=data_type,
        data_transport_mode=model_input.get("qconfig", {}).get("data_transmode", 1),
        mem_inplace=True,
        cluster_mode=model_input.get("qconfig", {}).get("cluster_mode", 0),
    ):
