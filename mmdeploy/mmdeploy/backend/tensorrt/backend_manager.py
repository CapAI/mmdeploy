...
class TensorRTManager(BaseBackendManager):
    ...
    def to_backend(
        ...
        **kwargs,
        ...
        backend_files = []
        for model_id, model_param, onnx_path in zip(range(len(ir_files)), model_params, ir_files):
            ...
            onnx2tensorrt(
                work_dir, save_file, model_id, deploy_cfg, onnx_path, device=device, partition_type=partition_type
            )
