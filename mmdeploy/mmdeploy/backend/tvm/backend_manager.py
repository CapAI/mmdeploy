...
class TVMManager(BaseBackendManager):
    ...
    def build_wrapper(
        ...
        **kwargs
        ...
        return TVMWrapper(backend_files[0], bytecode=bytecode, output_names=output_names, device=device)
    ...
    def to_backend(
        ...
        **kwargs
        ...
        from mmdeploy.utils import get_calib_filename, get_model_inputs, get_partition_config
        ...
        for model_id, onnx_path in enumerate(ir_files):
            ...
            code_path = osp.splitext(onnx_path)[0] + ".code" if use_vm else None
            ...
            if "qconfig" in model_input:
                ...
                partition_type = "end2end" if partition_cfgs is None else onnx_name
                dataset = HDF5Dataset(calib_path, model_input["shape"], model_type=partition_type, device=target)
