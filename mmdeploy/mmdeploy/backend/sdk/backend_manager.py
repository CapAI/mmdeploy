...
candidates = [f"../../../build/lib/{module_name}.*.so", f"../../../build/bin/*/{module_name}.*.pyd"]
        ...
        **kwargs,
        ...
        Args:
            ...
            deploy_cfg (Optional[Any], optional): The deploy config. Defaults
                to None.
        """
        assert deploy_cfg is not None, "Building SDKWrapper requires deploy_cfg"
        ...
        return SDKWrapper(model_file=backend_files[0], task_name=task_name, device=device)
