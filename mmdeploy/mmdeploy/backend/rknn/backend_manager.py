...
class RKNNManager(BaseBackendManager):
    ...
    def build_wrapper(
        ...
        **kwargs,
        ...
        return RKNNWrapper(
            model=backend_files[0], common_config=common_config, input_names=input_names, output_names=output_names
        )
    ...
    def get_version(cls) -> str:
        ...
        if not cls.is_available():
            ...
            rknn2_version = None
            try:
                rknn_version = pkg_resources.get_distribution("rknn-toolkit").version
            except Exception:
                pass
            try:
                rknn2_version = pkg_resources.get_distribution("rknn-toolkit2").version
            except Exception:
                pass
    ...
    def to_backend(
        ...
        **kwargs,
        ...
        assert is_available(), "RKNN is not available, please install RKNN first."
