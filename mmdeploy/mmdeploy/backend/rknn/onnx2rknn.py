...
def onnx2rknn(
    ...
    **kwargs
    ...
    input_size_list = get_backend_config(deploy_cfg).get("input_size_list", None)
    # update norm value
    ...
    ret = rknn.load_onnx(model=onnx_model, inputs=input_names, input_size_list=input_size_list, outputs=output_names)
    if ret != 0:
