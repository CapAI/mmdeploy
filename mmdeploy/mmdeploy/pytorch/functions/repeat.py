...
@FUNCTION_REWRITER.register_rewriter(func_name="torch.Tensor.repeat", backend="tensorrt")
def tensor__repeat__tensorrt(input: torch.Tensor, *size: Union[torch.Size, Sequence[int]]):
