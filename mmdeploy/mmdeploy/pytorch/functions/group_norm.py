...
@FUNCTION_REWRITER.register_rewriter(func_name="torch.nn.functional.group_norm", backend="ncnn")
def group_norm__ncnn(
    ...
    norm_reshaped = torch.nn.functional.instance_norm(input_reshaped, weight=weight_, bias=bias_, eps=eps)
