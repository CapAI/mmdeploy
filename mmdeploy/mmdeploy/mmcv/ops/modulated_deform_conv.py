...
@FUNCTION_REWRITER.register_rewriter("mmcv.ops.modulated_deform_conv.modulated_deform_conv2d", ir=IR.TORCHSCRIPT)
...
@SYMBOLIC_REWRITER.register_symbolic("mmcv.ops.modulated_deform_conv.ModulatedDeformConv2dFunction")
def modulated_deform_conv_default(
    g, input, offset, mask, weight, bias, stride, padding, dilation, groups, deform_groups
):
