    ...
    def register_symbolic(
        ...
        **kwargs,
        ...
        return self._registry.register_object(
            func_name, backend, ir, extra_checkers, is_pytorch=is_pytorch, arg_descriptors=arg_descriptors, **kwargs
        )
    ...
    def enter(self, cfg: Dict = dict(), env: Dict = dict(), opset: int = 11, **kwargs):
        ...
        for function_name, record_dict in symbolic_records:
            ...
            if is_pytorch:
                ...
                register_custom_op_symbolic(f"::{function_name}", symbolic_function, opset)
                ...
                try:
                    ...
                    assert issubclass(origin_func, Function), f"{function_name} is not an torch.autograd.Function"
                except Exception:
                    origin_func = None
